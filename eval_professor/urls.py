...
urlpatterns = [
    ...
    path('remove_student/<int:course_id>/<str:iris_roll>/', views.remove_student, name='remove_student'),
    ...
    path('remove_student_from_team/<int:team_id>/<str:iris_roll>/', views.remove_student_from_team, name='remove_student_from_team'),
